 ...
 */
package de.flapdoodle.apache.pivot.buildsupport;
...
public class ExtractMarkdownFromCode {
	...
	private static String extractMarkdown(String sourceFileName) throws IOException {
		...
		Collection<String> result = compactEmptyLines(surroundHeadlineWithEmptyLines(uncommentLineComment(uncommentThreeDots(shiftOneTabLeft(stripNonCodeLines(freeHeader(startWithFirstHeader(resolveIncludes(
	...
	private static Collection<String> uncommentLineComment(Collection<String> lines) {
		return Collections2.transform(lines, new Function<String, String>() {
